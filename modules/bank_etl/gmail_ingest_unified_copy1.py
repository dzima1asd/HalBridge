...
def upsert_row(cur, row: dict):
    ...
    try:
        ...
        # istnieje — aktualizujemy źródła, pending i ewentualnie tytuł/kontrahenta
        cur.execute(
            """
        ...
        # Jeśli stary tytuł to „Wiadomość z Inteligo” albo pusty, a nowy jest lepszy → nadpisz
        if row["direction"] == "in":
...
def main():
    ...
    for mid in ids:
        ...
        # Zapis tytułu WOG do inteligo_titles
        try:
            ...
            print("WARN: inteligo_titles zapis nieudany:", e, file=sys.stderr)
