...
def list_pending(con: sqlite3.Connection, ym: str):
    ...
    Działa z obecną strukturą transactions_final (bez is_pending).
    """

    # transakcje z ostatnich 2 dni tylko z danego miesiąca
    sql = """
        SELECT 
            a.op_date,
        ...
        WHERE 
            ...
            -- brak potwierdzenia: nie istnieje druga taka sama transakcja z późniejszą datą
            AND NOT EXISTS (
                SELECT 1
